...
### 1. Clone the repo
```bash
git clone git@github.com:azzahrapr/pandai-gadai-design.git
```
...
| `design-system/layout-guidelines.md` | Everyone | Design principles for all screens |
| `design-system/design-components.md` | Everyone | Component index with names and keys |
| `design-system/design-tokens.md` | Everyone | Color, spacing & typography tokens |
| `design-system/figma/figma-protocol.md` | Figma users | Technical rules for every `use_figma` call |
| `design-system/figma/figma-plugin-helpers.js` | Figma users | Token & component helper functions |
