        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-lg px-4 py-3 flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[14px] text-[#020617]">Rp850.000</span>
            </div>
            <div className="h-px bg-[#e2e8f0]" />
            <div className="flex items-center justify-between">
              <span className="text-[14px] font-semibold text-[#020617]">Subtotal</span>
              <span className="text-[16px] font-semibold text-[#023dff]">Rp850.000</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white px-4 py-4 flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1">
              ...
              <p className="text-[20px] font-bold text-[#023dff]">Rp850.000</p>
            </div>
            <button
              onClick={() => navigate('/pinjaman/selesai')}
              disabled={!agreed}
              className={`rounded-[6px] px-4 py-2 flex items-center gap-2 ${agreed ? 'bg-[#023dff]' : 'bg-[#023dff]/40'}`}
            >
