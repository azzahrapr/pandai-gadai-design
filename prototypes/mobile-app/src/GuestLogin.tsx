    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex items-center justify-end h-[56px] px-4 shrink-0">
          <button className="flex items-center gap-1.5 h-7 px-3 rounded-full bg-white/60 border border-white/80">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#374151" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="text-[13px] font-medium text-[#374151]">Butuh Bantuan?</span>
          </button>
        </div>
