...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    checklistItems: [
      { id: 'of-1', text: 'Melakukan packing item offload sesuai prosedur', category: 'Offloading' },
    ],
  },
  {
    id: 'pelayanan-nasabah',
...
export const MOCK_USERS: AppUser[] = [
  ...
  },
  {
    ...
    profile: {
      ...
      currentDay: 8,
      kanitId: 'kanit-001',
      activeMilestoneIds: ['canvassing', 'pelayanan-nasabah'],
      completedMilestoneIds: ['canvassing', 'pelayanan-nasabah'],
    },
  },
  {
    id: 'fl-003',
